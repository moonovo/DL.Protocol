...
namespace Friendcom.Protocol._1376_2
{
    ...
    {
        public Frame1376_2Up()
            : base()
        {
            FControl.DIR = 1;
            FAddress.IsDown = false;
        }


        private InformationUpField _fInformation = new InformationUpField();

        /// <summary>
        /// 信息域
        /// </summary>
        public InformationUpField FInformation
        {
